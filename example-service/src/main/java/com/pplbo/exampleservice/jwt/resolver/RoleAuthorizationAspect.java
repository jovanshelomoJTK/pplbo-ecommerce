package com.pplbo.exampleservice.jwt.resolver;
...
import com.pplbo.exampleservice.jwt.util.JwtUtil;
...
public class RoleAuthorizationAspect {
    ...
    @Around("@annotation(com.pplbo.exampleservice.jwt.customannotations.AllowedRoles)")
