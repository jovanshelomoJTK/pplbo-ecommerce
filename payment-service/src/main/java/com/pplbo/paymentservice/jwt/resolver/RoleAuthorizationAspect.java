package com.pplbo.paymentservice.jwt.resolver;
...
import com.pplbo.paymentservice.jwt.util.JwtUtil;
...
public class RoleAuthorizationAspect {
    ...
    @Around("@annotation(com.pplbo.paymentservice.jwt.customannotations.AllowedRoles)")
