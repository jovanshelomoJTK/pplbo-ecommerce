package com.pplbo.cartservice.jwt.resolver;
...
import com.pplbo.cartservice.jwt.util.JwtUtil;
...
public class RoleAuthorizationAspect {
    ...
    @Around("@annotation(com.pplbo.cartservice.jwt.customannotations.AllowedRoles)")
